...
<script type="text/javascript">
    ...
    <div id="rotate">
            <ul>
                <li><a href="#fragment-2"><span>车辆运营数据查询</span></a></li>
            </ul>
            
            <div id="fragment-2">
               <p>&nbsp;</p>
<p align="center" class="STYLE1">车辆运营数据查询</p>
<p>&nbsp;</p>
<form id="form" name="form" method="POST" action="runReport_carInfo.php" >
  ...
  <tr>
    ...
    <td>&nbsp;</td>
		                ...
		                <p>&nbsp;</p>  <table width="491" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><div align="center"><span class="STYLE2">* 数据更新至：2015-05-07</span></div></td>
                          </tr>
                        </table>
                <p> </p>
